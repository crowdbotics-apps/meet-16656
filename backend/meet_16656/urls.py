...
admin.site.site_header = "Meet"
admin.site.site_title = "Meet Admin Portal"
admin.site.index_title = "Meet Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Meet API",
        default_version="v1",
        description="API documentation for Meet App",
    ),
    public=True,
